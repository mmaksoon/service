          ...
          child: Column(
            children: [
              Container(
                ...
                height: 250,
                width: 250,
                child: Lottie.asset('assets/service.json',
                fit: BoxFit.cover,
                ),
              ),
              ...
              GestureDetector(
                ...
                child: FadeInRight(
                  ...
                  child: Container(
                      ...
                      child: const Text(' Забыли пароль? ', style: TextStyle(color: Colors.white70,fontWeight: FontWeight.bold),)),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: FadeInUp(
                    duration: const Duration(milliseconds: 1000),
                    child: const Card(child: Text('Не получилось войти ', style: TextStyle(color: Colors.white70,fontWeight: FontWeight.bold),))),
              ),
